            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{ route('tampiltiket') }}">Daftar pemesan</a>
                        <a class="navbar-brand" href="{{ route('search') }}">Cek hadir </a>
                        <a class="navbar-brand" href="{{ route('laporan') }}">laporan</a>
                    </div>
